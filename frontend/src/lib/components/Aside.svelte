	...
	<div class="border-t border-gray-300">
		<div class="p-4">
			...
			<div class="space-y-2">
				<a
					href="/user"
					class="flex w-full rounded-xl bg-gray-300 px-4 py-3 text-center text-sm hover:bg-gray-400 {$page
						.url.pathname === '/user'
						? 'bg-gray-400 font-bold'
						: ''}"
				>
				...
				<a
					...
					on:click={logout}
					class="block w-full rounded-xl bg-gray-300 px-4 py-3 text-center text-sm hover:bg-gray-400"
				>
					Logout
				</a>
			</div>
