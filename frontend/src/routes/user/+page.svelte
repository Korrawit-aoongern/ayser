...
<main class="flex-1 p-12">
	<h1 class="mb-8 text-4xl font-bold">User</h1>
	...
	<form class="max-w-2xl" on:submit|preventDefault={handleSaveProfile}>
		...
		<div class="mb-6">
			<label for="oldPassword" class="mb-2 block text-sm font-semibold">Old Password</label>
			<input
				type="password"
				class="w-full rounded border border-gray-300 px-4 py-2"
		...
		<div class="mb-6">
			<label for="newPassword" class="mb-2 block text-sm font-semibold">New Password</label>
			<input
				type="password"
				class="w-full rounded border border-gray-300 px-4 py-2"
		...
		<div class="mt-8">
			<h2 class="mb-4 text-2xl font-bold">Services</h2>
			{#if serviceMessage}
				<p class="mb-3 text-sm text-green-700">{serviceMessage}</p>
			{/if}
			<button
				type="button"
				class="inline-block rounded border-2 border-red-500 px-6 py-2 text-sm font-semibold text-red-500 hover:bg-red-500 hover:text-white disabled:opacity-50"
		...
		<div class="mt-8">
			<h2 class="mb-4 text-2xl font-bold">User</h2>
